...
export default function Footer() {
  return (
    ...
    <div className=' flex flex-row space-x-20 w-5/6 h-38 mt-5 text-black bg-white justify-evenly'>
        ...
        <div><a href='https://www.facebook.com/people/Harsh-Jain/100005250007742' ><AiFillFacebook/></a>
        </div>
        <div><a href='https://www.linkedin.com/in/harsh-jain2001/' ><AiFillLinkedin/></a>
        </div>
